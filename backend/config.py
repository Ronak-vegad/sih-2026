...
# ── NVIDIA NIM ───────────────────────────────────────────────────
# One provider for chat + embeddings, both via NIM's OpenAI-compatible API.
NVIDIA_API_KEY   = os.getenv("NVIDIA_API_KEY", "")
NIM_BASE_URL     = "https://integrate.api.nvidia.com/v1"
NIM_RANKING_URL  = "https://integrate.api.nvidia.com/v1/ranking"

# NOTE (Sept 2026): the nemotron-super-49b / nv-embedqa-e5-v5 /
# nv-rerankqa-mistral-4b-v3 generation reached end-of-life in Aug 2026 and now
# returns HTTP 410. These are their live successors, verified against
# GET /v1/models. NVIDIA no longer publishes a hosted reranking model, so the
# pipeline relies on hybrid BM25 + dense fusion for ordering.
...
# Nemotron Super 49B is a hybrid reasoning model: this line must lead the
# system prompt, or the model emits <think>...</think> traces in its answer.
THINKING_TOGGLE  = "detailed thinking off"
